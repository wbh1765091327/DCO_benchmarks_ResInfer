...
unsigned long long tot_pruned_objects = 0;     // 总剪枝对象数
unsigned long long correct_pruned_objects = 0; // 正确剪枝的对象数

long double sqr_dist_time = 0;
...
void clear(){
    ...
    tot_full_dist = 0;
    tot_pruned_objects = 0;
    correct_pruned_objects = 0;
}
