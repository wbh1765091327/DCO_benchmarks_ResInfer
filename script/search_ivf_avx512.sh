...
for K in 10; do
  for data in "${datasets[@]}"; do
    ...
    result_path="./results/recall@${K}/ivf/simd/${data}"
    ...
    #   ./build/src/search_ivf_avx512_dist -d ${randomize} -i ${index} -q ${query} -g ${gnd} -r ${res1} -t ${trans} -k ${K} -s ${efSearch} 
    #   # ./build/src/search_ivf_avx512_pruning -d ${randomize} -i ${index} -q ${query} -g ${gnd} -r ${res2} -t ${trans} -k ${K} -s ${efSearch}
    ...
    # ./build/src/search_ivf_avx512_dist -d ${randomize} -n ${data} -i ${index} -q ${query} -g ${gnd} -r ${res1} -t ${trans} -l ${linear} -k ${K} -s ${efSearch}
    # # ./build/src/search_ivf_avx512_pruning -d ${randomize} -n ${data} -i ${index} -q ${query} -g ${gnd} -r ${res2} -t ${trans} -l ${linear} -k ${K} -s ${efSearch}
    ...
    # ./build/src/search_ivf_avx512_dist -d ${randomize} -n ${data} -i ${index} -q ${query} -g ${gnd} -r ${res1} -t ${trans} -e ${sigma} -k ${K} -s ${efSearch}
    # # ./build/src/search_ivf_avx512_pruning -d ${randomize} -n ${data} -i ${index} -q ${query} -g ${gnd} -r ${res2} -t ${trans} -e ${sigma} -k ${K} -s ${efSearch}
  
    randomize=6
    res1="${result_path}/${data}_ad_ivf_${randomize}_pruning_time.log"
    res2="${result_path}/${data}_ad_ivf_${randomize}_simd_dist_time.log"
    ...
    # ./build/src/search_ivf_avx512_pruning -d ${randomize} -n ${data} -i ${index} -b ${code} -q ${query} -g ${gnd} -r ${res1} -t ${trans} -l ${linear} -k ${K} -s ${efSearch}
