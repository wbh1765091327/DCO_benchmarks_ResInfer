...
if __name__ == "__main__":
    ...
    parser.add_argument('-n', '--M', help='M', default='16')
    parser.add_argument('-e', '--ef', help='ef', default='500')
    parser.add_argument('-c', '--C', help='C', default='316')
    ...
    if index_type == "hnsw1":
        filename = f'./logger/{dataset}_logger_{method_type}_{index_type}_ef{ef}_M{M}.fvecs'
        save_path = f'./DATA/{dataset}/linear/linear_{index_type}_ef{ef}_M{M}_{method_type}_{K}.log'
    else:
        filename = f'./logger/{dataset}_logger_{method_type}_{index_type}_{C}.fvecs'
        save_path = f'./DATA/{dataset}/linear/linear_{index_type}_{C}_{method_type}_{K}.log'
